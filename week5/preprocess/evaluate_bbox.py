...
from preprocess.evaluation_funcs import performance_accumulation_window, performance_evaluation_window
...
def evaluate_bb(bb_list_gt, bb_list_annotation):
    ...
    [window_precision, window_sensitivity, window_accuracy] = \
            performance_evaluation_window(windowTP, windowFN, windowFP)
    print("windowTP",windowTP,"windowFN",windowFN,"windowFP",windowFP)
    print("window_precision",window_precision,"window_sensitivity",window_sensitivity,"window_accuracy",window_accuracy)
