...
def calculateImagesMetrics(im_directory,mask_directory,gt_directory):
...
def main():
	...
	maxList, minList, formFactorList, fillingRatioList = calculateImagesMetrics(im_directory,mask_directory,gt_directory)
