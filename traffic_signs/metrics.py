...
def create_signal_type_dict(signals_list):
    ...
    for signal_type in signal_type_dict:
        ...
        tmp_std['pixel_std'] = int(np.std([signal.pixels for signal in tmp_sl]))
        tmp_std['pixel_mean'] = int(np.mean([signal.pixels for signal in tmp_sl]))
        tmp_std['pixel_min'] = np.max([signal.pixels for signal in tmp_sl])
        tmp_std['pixel_max'] = np.min([signal.pixels for signal in tmp_sl])

        tmp_std['fratio_std'] = np.std([signal.fratio for signal in tmp_sl])
        tmp_std['fratio_mean'] = np.mean([signal.fratio for signal in tmp_sl])
        tmp_std['fratio_max'] = np.max([signal.fratio for signal in tmp_sl])
        tmp_std['fratio_min'] = np.min([signal.fratio for signal in tmp_sl])

        tmp_std['ffactor_std']= np.std([signal.ffactor for signal in tmp_sl])
        tmp_std['ffactor_mean']= np.mean([signal.ffactor for signal in tmp_sl])
        tmp_std['ffactor_max']= np.max([signal.ffactor for signal in tmp_sl])
        tmp_std['ffactor_min']= np.min([signal.ffactor for signal in tmp_sl])
